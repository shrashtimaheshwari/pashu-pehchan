    ...
    <div className="w-full flex flex-col gap-10 z-30">
      <div className='flex flex-col w-full border-2'>
        <div className='flex items-center justify-between  p-1 w-full'>
          <img src={govtLogo} alt="Govt Logo" className='h-12' />
          <img src={dairyLogo} alt="Govt Logo" className='h-12' />
        </div>
        <div className='flex items-center justify-between p-2'>
          <div className=' w-1/2 flex items-center justify-between'>
            <NavLink to="/" className='text-md'>Home</NavLink>
            <NavLink to="/contact" className='text-md'>Contact Us</NavLink>
          </div>
          <div className='w-1/2 flex items-center justify-end'>
            <NavLink to="/login" className='text-md border-1 rounded-4xl px-2 py-0 bg-cyan-500 p-1'>Login</NavLink>
          </div>
        </div>
      </div>
